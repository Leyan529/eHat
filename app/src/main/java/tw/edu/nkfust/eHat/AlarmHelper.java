...
public class AlarmHelper {
	...
	public void setAlarm(View view, final TextView name, final Button status) {
				...
				new AlertDialog.Builder(context)
						...
						.setPositiveButton(R.string.textOfButton_DialogYes, new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								switch (status.getId()) {
									case R.id.buttonOfTheTimerOneStatus:
										if (!MainActivity.mRFduinoManager.isOutOfRange()) MainActivity.mRFduinoManager.onStateChanged(3);
										MainActivity.isTimerOneCounting = false;
										break;
									case R.id.buttonOfTheTimerTwoStatus:
										if (!MainActivity.mRFduinoManager.isOutOfRange()) MainActivity.mRFduinoManager.onStateChanged(5);
										MainActivity.isTimerTwoCounting = false;
										break;
									case R.id.buttonOfTheTimerThreeStatus:
										if (!MainActivity.mRFduinoManager.isOutOfRange()) MainActivity.mRFduinoManager.onStateChanged(7);
