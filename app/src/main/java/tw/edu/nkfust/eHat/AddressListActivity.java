		...
		listViewOfAddress.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
				...
				new AlertDialog.Builder(AddressListActivity.this)
						.setItems(new String[] { getString(R.string.textOfMenuItem_Draw), getString(R.string.textOfMenuItem_Delete) }, new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog, int which) {
								switch (which) {
									case 0:
										...
										MainActivity.toLatLng = MainActivity.mMapHelper.addressToLatLng(address);
										MainActivity.toMarkerOpt = MainActivity.mMapHelper.setMarker(MainActivity.toLatLng.latitude, MainActivity.toLatLng.longitude);
